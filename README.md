...
```xml
    ...
    <style name="Base.Theme.HelloAppTI22A4" parent="Theme.Material3.DayNight.NoActionBar">
...
- Jika diawal pembuatan project kita memilih template empty views activity, maka pada layout otomatis terbuat file activity_home.xml dan pada java akan terbuat MainHome.java. Kemudian langsung saja kita buka activity_home.xml lalu masukkan code seperti berikut :
...
<RelativeLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <ImageView
        ...
        android:src="@drawable/backgroundlauncher" />
    ...
    <Button
        ...
        android:layout_centerHorizontal="true"
        android:layout_marginTop="20dp"
        android:text="@string/project_fibonacci"
        tools:ignore="UsingOnClickInXml" />
...
- Selanjutnya kita buka MainHome.java untuk menambahkan code intent untuk masing-masing tombol.
...
```xml
<resources>
    <string name="app_name">Fajri App</string>
    <string name="Hello">bagaimana anda!</string>
    <string name="button_label_toast">Toast</string>
    <string name="button_label_count">Count</string>
    <string name="count_initial_value">0</string>
    <string name="toast_mesage">bilangan fibonacci</string>
    <string name="button_label_fibonancci">Mode</string>
    ...
    <string name="project_fibonacci">Project Fibonacci</string>
...
<androidx.constraintlayout.widget.ConstraintLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <TextView
        ...
        android:textColor="@color/colorFibonacciGreen"
...
<RelativeLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <ScrollView
        ...
        <LinearLayout
            ...
            <TextView
                android:id="@+id/aricle_suheading"
                android:layout_width="match_parent"
                android:layout_height="wrap_content"
                android:padding="@dimen/padding_regular"
